...
export const CONSENT_COPY = {
  ko: {
    ...
    necessaryDescription: "로그인 유지, 보안, 세션 관리 등 서비스 작동에 필요합니다.",
    alwaysActive: "Always Active",
    analyticsTitle: "분석 쿠키",
    analyticsDescription: "Google Analytics로 서비스 사용 흐름과 성능을 측정합니다.",
    adsTitle: "광고 쿠키",
    adsDescription: "Google AdSense 광고 제공과 맞춤 광고 동의에 사용될 수 있습니다.",
  ...
  en: {
    ...
    necessaryDescription: "Required for sign-in, security, session management, and core service operation.",
    alwaysActive: "Always Active",
    analyticsTitle: "Analytics cookies",
    analyticsDescription: "Measure product usage and performance with Google Analytics.",
    adsTitle: "Advertising cookies",
    adsDescription: "May be used for Google AdSense delivery and ad personalization consent.",
  ...
  ja: {
    ...
    necessaryDescription: "ログイン維持、セキュリティ、セッション管理などに必要です。",
    alwaysActive: "Always Active",
    analyticsTitle: "分析Cookie",
    analyticsDescription: "Google Analyticsで利用状況とパフォーマンスを測定します。",
    adsTitle: "広告Cookie",
    adsDescription: "Google AdSenseの広告配信とパーソナライズ同意に使用される場合があります。",
