...
export const metadata: Metadata = {
  ...
  description: "DREAMWISH 개인두뇌 AI 서비스 이용약관입니다."
};
      ...
      <article className="mx-auto max-w-3xl rounded-app border border-app-border bg-app-card p-6 shadow-app sm:p-8">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-app-muted">
          ...
          <TermsSection title="2. 계정과 보안">
            ...
            파일 업로드, 결제 기능은 사용자가 직접 승인한 범위에서만 사용해야 합니다.
          </TermsSection>
          ...
          <TermsSection title="5. 결제와 환불">
            유료 기능은 결제 제공자의 처리 결과에 따라 활성화됩니다. 결제 실패, 취소, 환불은
            서비스 정책과 결제 제공자의 규정에 따라 처리됩니다.
          </TermsSection>
          <TermsSection title="6. 서비스 변경">
            운영자는 보안, 법령 준수, 기능 개선을 위해 서비스 기능과 정책을 변경할 수
            있습니다. 중요한 변경은 합리적인 방식으로 안내합니다.
          </TermsSection>
          <TermsSection title="7. 개인정보와 쿠키">
