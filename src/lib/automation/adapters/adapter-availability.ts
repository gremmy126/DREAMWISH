const IMPLEMENTED_ACTIONS: Record<string, readonly string[]> = {
  gmail: ["watch-new-email", "send-email", "create-draft", "permanently-delete-email", "mark-read", "mark-unread", "archive-email", "add-label", "remove-label", "download-attachment", "search-email"],
